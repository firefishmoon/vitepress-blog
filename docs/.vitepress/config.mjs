...
export default defineConfig({
    ...
    // 网站描述，有利于被搜索引擎捕获
    description:
        "火月's tech blog: ideas of making money, sharing insights, tips, and experiences in web technologies.",
    ...
    themeConfig: {
        ...
        // 顶部导航栏左侧的社交平台跳转
        socialLinks: [{ icon: "github", link: "https://github.com/firefishmoon" }],
        // 首页底部版权声明
        footer: {
            copyright: "Copyright © 2025-present firefishmoon",
        },
        // 【文章页面左侧导航】
        sidebar: {
